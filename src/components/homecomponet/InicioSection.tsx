...
const InicioSection = () => {
  return (
    <section className={clsx("py-10 flex items-center flex-col w-full max-w-4xl ")}>
      <div className="container mx-auto flex flex-col items-center justify-center">
        <div className="max-w-lg text-center flex items-center flex-col">
          <Image src="/Ecoj (1).png" alt="Logo" width={250} height={250} className="floating" />
          <h2 className="text-3xl font-bold text-white mt-6">
            ¡Bienvenidos a EcoRaices!
          </h2>
          <p className="text-lg text-white mt-4">
            Descubre la biodiversidad urbana de los municipios guajiros con
            EcoRaices. Nuestra plataforma te permite geolocalizar y
            documentar las especies arbóreas que embellecen nuestras calles
            y plazas. Únete a nuestra comunidad y juntos, protejamos y
